...
<div id="content-panel">
  ...
  <form action="{$smarty.server.SCRIPT_NAME}?action=submit&amp;subaction=add" method="post" enctype="multipart/form-data" name="programs-add-form">
  {if isset($error_message)}<span class="error">Error: {$error_message}</span>{/if}
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        <th colspan="2" scope="col">Add New Program</th>
      </tr>
      <tr>
        <td>Name:<br>
      ...
      <tr>
        <td>Update Executable:<br>
          <span class="description">You can leave this empty if you don't plan on using auto-update on this program.</span></td>
